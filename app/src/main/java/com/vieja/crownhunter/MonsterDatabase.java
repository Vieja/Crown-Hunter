...
public class MonsterDatabase {
    public static final List<MonsterInfo> list = Arrays.asList(
            ...
            new MonsterInfo(28,"Lunastra",R.drawable.m_lunastra,Achievement.WORLD_ADD),
            new MonsterInfo(29,"Deviljho",R.drawable.m_deviljho,Achievement.WORLD_ADD),
            ...
            new MonsterInfo(50,"Yian Garuga",R.drawable.m_yian_garuga,Achievement.ICEBORNE),
            ...
            new MonsterInfo(55,"Stygian Zinogre",R.drawable.m_stygian_zinogre,Achievement.ICEBORNE_ADD),
